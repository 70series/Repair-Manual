...
// 2017/08/31 add start ver1.3.0
    ...
    // 手順SeePage見せ方改善
    // ---------------------
    // 絞込み対象の参照先ID を内部変数に保持
    Service.Flow.filterRefId = filterRefId;
// 2017/08/31 add end ver1.3.0
...
// 2017/08/31 del start ver1.3.0
//  Service.$callbackProcedures(
//      tabKey, paraID, Service.Flow.sbParaID, null, true);
// 2017/08/31 del end ver1.3.0
// 2017/08/31 add start ver1.3.0
    // ---------------------
    // 手順SeePage見せ方改善
    // ---------------------
    // 手順詳細画面に、絞込み対象の参照先ID も渡す。
    Service.$callbackProceduresWithFilterRefId(
        tabKey, paraID, Service.Flow.sbParaID, null, true, Service.Flow.filterRefId);
// 2017/08/31 add end ver1.3.0
